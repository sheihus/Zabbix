...
ZABBIX_PATTERN_5=$bl'JavaGateway='$tl
ZABBIX_PATTERN_6=$bl'JavaGatewayPort='$tl
ZABBIX_PATTERN_7=$bl'StartJavaPollers='$tl
...
ZABBIX_STR_5="JavaGateway=192.168.56.101"
ZABBIX_STR_6="JavaGatewayPort=10052"
ZABBIX_STR_7="StartJavaPollers=5"

for i in {1..7}   # patching zabbix_server.conf
do
